...
function saisirJoueur(){
    var joueur = {
    nom :  readline.question("Quel est le nom du nouveau joueur ? "),
    age : readline.question("Quel est l'age du nouveau joueur ? "),
    estUnHomme: true
    }
...
function afficherMenu() {
    ...
    txtMenu += "5.saisir un joueur\n";
    txtMenu += "6.ajouter un joueur\n";
    txtMenu += "9.quitter";
    console.log(txtMenu);
}